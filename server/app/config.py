...
class ExamplesData:
    ...
    EXAMPLE_THIRD_CLIENT_EMAIL = os.getenv("EXAMPLE_THIRD_CLIENT_EMAIL")
    EXAMPLE_FOURTH_CLIENT_EMAIL = os.getenv("EXAMPLE_FOURTH_CLIENT_EMAIL")
    EXAMPLE_FIFTH_CLIENT_EMAIL = os.getenv("EXAMPLE_FIFTH_CLIENT_EMAIL")
    EXAMPLE_SIXTH_CLIENT_EMAIL = os.getenv("EXAMPLE_SIXTH_CLIENT_EMAIL")
    EXAMPLE_FIRST_TRAINER_EMAIL = os.getenv("EXAMPLE_FIRST_TRAINER_EMAIL")
    EXAMPLE_SECOND_TRAINER_EMAIL = os.getenv("EXAMPLE_SECOND_TRAINER_EMAIL")
    EXAMPLE_THIRD_TRAINER_EMAIL = os.getenv("EXAMPLE_THIRD_TRAINER_EMAIL")